...
{
    [self showMessageWithIcon:[UIImage imageNamed:@"refresh@2x.png"] message:msg hideDelay:2 onHide:onHide];
}
...
{
    [self showMessageWithIcon:[UIImage imageNamed:@"refresh@2x.png"] message:msg hideDelay:1 onHide:onHide];
}
...
{
    [self showMessageThenHide:msg toView:view onHide:nil Time:time];
}
...
{
    UIView *window = [(AppDelegate *)[UIApplication sharedApplication].delegate window];
    [MBProgressHUD showMessageThenHide:msg toView:window Time:time];
}
